...
<body>
	...
	<br>
    <div align='center'>
     <input type='submit' name='Freeze' value='Freeze' id='Freeze'class="btn btn-primary active">
     <input type="submit" name ='Delete' value='DELETE'id='DELETE' class="btn btn-primary active">
